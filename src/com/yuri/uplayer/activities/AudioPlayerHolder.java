...
import com.yuri.uplayer.ui.fragments.AudioPlayerFragment;
...
import static com.yuri.uplayer.Constants.INTENT_PLAYLIST_LIST;
...
public class AudioPlayerHolder extends Activity implements ServiceConnection {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(0, SEARCH, 0, R.string.cd_search)
				.setIcon(R.drawable.apollo_holo_light_search)
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		if (MusicUtils.mService != null && MusicUtils.getCurrentAudioId() != -1) {
			if (MusicUtils.isFavorite(this, MusicUtils.getCurrentAudioId())) {
				...
				// Theme chooser
				ThemeUtils.setActionBarItem(this, favorite,
	...
	private void initActionBar() {
		...
		// Theme chooser
		ThemeUtils.setActionBarBackground(this, getActionBar(),
	...
	private String shareCurrentTrack() {
		...
		String currentTrackMessage = getResources().getString(
				R.string.now_listening_to)
				+ " "
	...
	private void initColorstrip() {
		...
		mColorstrip.setBackgroundColor(getResources().getColor(
