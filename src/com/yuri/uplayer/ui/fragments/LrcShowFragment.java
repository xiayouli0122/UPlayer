...
import com.yuri.uplayer.baidu.music.BaiduLrc;
import com.yuri.uplayer.baidu.music.BaiduMusic;
import com.yuri.uplayer.helpers.utils.MusicUtils;
import com.yuri.uplayer.lrc.utils.HttpTool;
import com.yuri.uplayer.lrc.utils.LRCXmlParser;
import com.yuri.uplayer.lrc.utils.SavelrcTool;
...
public class LrcShowFragment extends Fragment {
	...
	class UIUpdateThread implements Runnable {
		...
		public void run() {
			while (isupdatalrc) {
				try {
					if (MusicUtils.mService.isPlaying() && ishavelrc == true
							&& MusicUtils.songPathName != null) {
	...
	Handler nameshandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				System.out.println(MusicUtils.getTrackName() + "-"
						+ MusicUtils.getArtistName());
				break;
