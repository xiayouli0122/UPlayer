...
package com.yuri.uplayer.ui.fragments.grid;
...
import com.yuri.uplayer.ui.adapters.AlbumAdapter;

import static com.yuri.uplayer.Constants.*;
...
public class AlbumsFragment extends Fragment implements LoaderCallbacks<Cursor>,
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        // AlbumAdapter
        mAlbumAdapter = new AlbumAdapter(getActivity(), R.layout.listview_items, null,
...
//        mGridView = (GridView)root.findViewById(R.id.gridview);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
        ...
        menu.add(0, SEARCH, 0, getResources().getString(R.string.search_music));
